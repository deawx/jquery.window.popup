        ...
        init : function(){
            ...
            $(this.element).on({
                click : function(event){
                    ...
                    // popup
                    window.open(''+ set_href +'',''+ reinit_title +'','width='+ set_width +',height='+ set_height +',top='+ reinit_top +',left='+ reinit_left +',status='+ set_status +',fullscreen='+ set_fullscreen +', channelmode='+ set_channelmode +', location='+ set_location +', menubar='+ set_menubar +', toolbar='+ set_toolbar +', resizable='+ set_resizable +', scrollbars='+ set_scrollbars +'');
